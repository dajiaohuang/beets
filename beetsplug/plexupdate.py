...
from beetsplug._utils.requests import BeetsHTTPError, TimeoutAndRetrySession
...
class PlexUpdate(BeetsPlugin):
    ...
    def update(self, lib: Library) -> None:
        ...
        try:
            ...
            log.warning("Plex library update failed: %s", e)
        except BeetsHTTPError as e:
    ...
    def load_token(self) -> JSONDict:
        ...
        if self._token_cache is None:
            with (
                ...
                open(self.token_path, encoding="utf-8") as f,
            ):
    ...
    def wait_for_login(
        ...
        while time.monotonic() < deadline:
            ...
            try:
                ...
                log.debug("Plex pin polling failed", exc_info=True)
                continue
...
class PlexAPI:
    ...
    def get_music_section(self) -> str | None:
        ...
        url = urljoin(self.base_url, "library/sections")

        # The session requests JSON by default, which PMS honors for
        # this endpoint.
    ...
    def update_library(self) -> requests.Response:
        ...
        url = urljoin(self.base_url, f"library/sections/{section_key}/refresh")
